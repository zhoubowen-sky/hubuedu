...
;
            ...
            $_POST['course_chapter_video_url'] = $z['savepath'] . $z['savename'];
            /**
             * 这里存储用户头像的文件路径
             */
...
;
            ...
            $_POST['course_chapter_ppt_url'] = $z['savepath'] . $z['savename'];
            /**
             * 这里存储用户头像的文件路径
             */
            $_POST['course_chapter_time'] = date('Y-m-d H:i:s');
...
;
            ...
            $_POST['course_name_pic'] = $z['savepath'] . $z['savename'];
            /**
             * 这里存储用户头像的文件路径
             */
...
;
            ...
            $_POST['course_chapter_video_url'] = $z['course_chapter_video_url']['savepath'] . $z['course_chapter_video_url']['savename'];
            /**
             * 这里存储视频的文件路径
             */
            $_POST['course_chapter_video_size'] = $z['course_chapter_video_url']['size']; // 存储视频文件的大小
            $_POST['course_chapter_ppt_url'] = $z['course_chapter_ppt_url']['savepath'] . $z['course_chapter_ppt_url']['savename'];
            /**
             * 这里存储PPT的文件路径
             */
